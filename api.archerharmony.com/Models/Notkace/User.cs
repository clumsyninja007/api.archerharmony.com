...
public class User
{
    ...
    public bool? _2faConfigured { get; set; }
    public byte[] _2faSecret { get; set; }
    public DateTimeOffset? _2faCutoffDate { get; set; }
    public string Theme { get; set; }

    public virtual ICollection<HdTicket> HdTicketOwner { get; set; }
    public virtual ICollection<HdTicket> HdTicketSubmitter { get; set; }
